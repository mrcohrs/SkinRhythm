...
export function generateRoutinePDF(data: RoutinePDFData): typeof PDFDocument {
  ...
  // Title Page
  doc.fontSize(28).font('Helvetica-Bold').text('AcneAgent', { align: 'center' });
  doc.moveDown(0.5);
  ...
  doc.fontSize(9).font('Helvetica').text(
    ...
    'AcneAgent is not a substitute for professional dermatological care. If you experience severe ' +
  ...
  doc.moveDown(1);
  doc.fontSize(9).font('Helvetica-Oblique').text('Generated by AcneAgent - Your Personalized Skincare Platform', { align: 'center' });
