        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 py-16">
          <Card className="p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground/90">
              ...
              <section>
                <h2 className="text-xl font-semibold mb-3">PROFESSIONAL DISCLAIMER</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-3">AFFILIATES DISCLAIMER</h2>
                <p>
