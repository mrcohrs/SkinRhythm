          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="ingredient-checker" className="space-y-6 mt-6">
              <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium">
                              {Math.max(0, 3 - ((user as any)?.scanCount || 0))} free scan{Math.max(0, 3 - ((user as any)?.scanCount || 0)) === 1 ? '' : 's'} remaining
                            </div>
                ...
                {!isPremium && (user as any)?.scanCount && (user as any).scanCount >= 3 ? (
...
Hyaluronic Acid"
                      ...
                      <div className="flex gap-3">
                        <Button
                          ...
                          disabled={!ingredientInput.trim() || scanMutation.isPending || (!isPremium && !!user && ((user as any).scanCount || 0) >= 3)}
                          className="flex-1"
