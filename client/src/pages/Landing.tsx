...
import { ArrowRight, Shield, Sparkles, FlaskConical, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div 
          className="absolute right-0 top-0 bottom-0 w-1/2 lg:w-2/5 opacity-20 dark:opacity-10 bg-contain bg-right bg-no-repeat pointer-events-none"
          style={{ backgroundImage: `url(${moleculeImg})` }}
        />
        
        <div className="relative z-10 w-full">
          <div className="container mx-auto px-4 md:px-8 lg:px-16 py-20 md:py-24">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <Button
                variant="outline"
                size="lg"
                onClick={() => window.location.href = '/ingredient-checker'}
